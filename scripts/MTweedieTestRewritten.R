...
print('The fastest method is the method where line 29-35 is altered, and instead of using a for loop we are using a for each loop. This script is a lot faster then the other methods. It could be that this is faster because I am opening the clusters in the beginning of the script, but in the MTweedie function change, I am closing the clusters after the function has run. I am not sure why this method is faster and if it is correct, but I would love to get feedback on this :-)')